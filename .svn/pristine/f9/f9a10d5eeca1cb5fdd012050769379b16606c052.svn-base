 ...
 * 
 */
public class FindEmailFramgent extends BaseFragment implements OnClickListener, VolleyStringListener {
	...
	protected View initView(LayoutInflater inflater) {
		...
		View view = inflater.inflate(R.layout.fragment_findemil, null);
	...
	private void initMsg() {
		// TODO Auto-generated method stub
		VolleyHttpUtil vtp = VolleyHttpUtil.getInstance(getActivity());
		vtp.ResetEmail(getActivity(), rcode, strpass, strrpass, phone);
		vtp.setObjectList(this);
	}
